...
async function main() {
    ...
    const { error: secErr } = await supabase.from('venue_sections').insert([
        { id: section1, venue_id: venueId, name: 'General Admission', description: 'Entry to brunch. Food not included.', capacity: 100, default_price: 2500, color: '#F2A900', sort_order: 1 },
        { id: section2, venue_id: venueId, name: 'VIP Booth', description: 'Includes a bottle of champagne and seating for 4.', capacity: 10, default_price: 15000, color: '#FF006E', sort_order: 2 },
        { id: section3, venue_id: venueId, name: 'Bottomless Mimosas Add-On', description: 'Add-on only. Must purchase GA or VIP.', capacity: 50, default_price: 3000, color: '#3B82F6', sort_order: 3 }
    ]);
