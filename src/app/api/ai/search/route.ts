...
const SYSTEM_PROMPT = `You are Culture AI, the official assistant for the Culture app — a civic platform for Compton, CA.
    ...
    const response = await fetch("https://api.openai.com/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          ...
          {
            role: "user",
            content: `Here is the current Culture database for Compton, CA:\n${contextData}\n\n---\nResident's question: ${query}`,
          },
        ],
        max_tokens: 800,
        temperature: 0.5,
