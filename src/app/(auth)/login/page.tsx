...
function LoginPageInner() {
  ...
  return (
    <div className="max-w-[430px] mx-auto min-h-dvh bg-midnight flex flex-col items-center justify-center px-6 relative">
      {/* Back button */}
      <button
        type="button"
        onClick={handleBack}
        aria-label="Back"
        className="absolute top-4 left-4 w-10 h-10 rounded-full bg-white/[0.06] border border-border-subtle text-txt-secondary flex items-center justify-center press hover:text-white hover:bg-white/[0.1] transition-all"
      >
